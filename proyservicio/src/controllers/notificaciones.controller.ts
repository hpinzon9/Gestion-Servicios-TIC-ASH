...
export class NotificacionesController {
  ...
  async create(
    ...
    notificaciones: Omit<Notificaciones, 'string'>,
  ...
  enviarSmS(mensaje:any){
    const accountSid="AC03e05124feebb538e3d29847938446aa";
    const authoken="7670194a481564ae7aec2fc561c753ba";

    const twilio= require("twilio");
    const cliente= new twilio(accountSid,authoken );
    ...
    .create({
     ...
     .then((messaje: any)=> console.log(messaje.sid));
  }
}

function then(arg0: (messaje: any) => void) {
